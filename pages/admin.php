            ...
            <div class="search-add">
                ...
                <div style="display:flex;gap:8px;">
                    <div class="export-buttons">
                        ...
                        <button class="import-excel" onclick="document.getElementById('importExcelFile').click()">📥
                            Import Excel</button>
                        <button class="import-pdf" onclick="document.getElementById('importPDFFile').click()">📥 Import
                            PDF</button>
                    </div>
                ...
                <table class="price-table" id="priceTable">
                    ...
                    <?php foreach ($produkList as $index => $p): ?>
                        <tr data-id="<?= htmlspecialchars($p['id']) ?>"
                            data-kat="<?= htmlspecialchars($p['id_kategori']) ?>">
                            <td><?= $index + 1 ?></td>
                            ...
                            <td>
                                <?php if (!empty($p['gambar_url'])): ?>
                                    <img class="product-thumb" src="<?= htmlspecialchars($p['gambar_url']) ?>"
