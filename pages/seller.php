...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-print { background: #27ae60; color: white; border: none; padding: 12px 30px; font-size: 16px; border-radius: 5px; cursor: pointer; box-shadow: 0 2px 5px rgba(0,0,0,0.2); }
...
@media (min-width: 1281px) {
  .product-grid {
    ...
    @media (max-width:480px){
      .dashboard-container{padding:15px;margin:15px auto;}
      .filter-box{text-align:left;}
      .filter-box select{width:100%;margin-bottom:8px;}
      .filter-box button{width:100%;}
      .export-buttons button{width:100%;margin:6px 0;}
